...
namespace Preparcial.Vista
{
    public partial class FrmMain : Form
    {
        ...
        private void ActualizarOrdenesUsuario()
        {
            ...
            //Poniendo A en vez de a en idarticulo
        ...
        {
            //Añadiendo general tab para que no salga que no tenemos acceso
            if (tabControl1.SelectedTab.Name.Equals("generalTab") || u.Admin)
            {
